...
mail($address, 'Introduction', $message, $headers);
...
$sql_query = "UPDATE $tblname SET status='introduced' WHERE id='$clientid'";
$conn->query( $sql_query );

$tblname = 'mails';

$sql_query = "INSERT INTO $tblname (clientid, template, mailtype, period, remaining) VALUES ($clientid, $mailbody, 'intro', $period, $period)";
$conn->query( $sql_query );
